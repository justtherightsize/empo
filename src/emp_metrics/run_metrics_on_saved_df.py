...
def calc_metrics(pth, model_id, metrics: List[str]):
    ...
    if "epitome" in metrics:     # Calculate EPITOME, DIFF-EPITOME metrics
        ...
        epitome_report = avg_epitome_score(pred_IP_scores, pred_EX_scores, pred_ER_scores, gt_IP_scores,
...
if __name__ == "__main__":
    ...
    parser.add_argument("-m", "--metrics", nargs="+", help="one or more of: epitome, bertscore")
